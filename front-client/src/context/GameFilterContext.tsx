...
export const GameNotCreated = (elements: FallbackElement) => FilterContext(({ game }: IGameContext) => !game, elements);

export const PlayerVip = (elements: FallbackElement) =>
    FilterContext(({ game, player }: IGameContext) => game.state === GameState.LOBBY && player?.vip, elements);
