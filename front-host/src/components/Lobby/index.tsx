...
const Lobby = () => {
    ...
    return (
        <div className="max-w-4xl h-full m-auto flex items-center justify-center">
            <div className="flex-1 grid grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-gray-800/50 backdrop-blur-sm rounded-xl p-6">
                    <div className="flex flex-col items-center justify-center h-full gap-8">
                        <div className="w-full flex justify-between pr-4 py-8 border-b border-solid">
